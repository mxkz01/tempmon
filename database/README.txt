...
We have been managing SQL Data via phpMyAdmin which seems to be the easiest way to get things up and running. Once you've created the database, user and assigned permissions, you can use the Import feature from within phpMyAdmin to import the database structure from the .sql file.
